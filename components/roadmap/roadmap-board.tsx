        ...
        {columns.map((status, col) => {
          ...
          return (
            <section key={status} className="flex min-w-0 flex-col gap-4">
              <div
                className="text-mono-sm flex items-center gap-2.5 font-mono tracking-[0.08em] uppercase"
              ...
              >
                ...
                />
                <h2 className="text-mono-sm m-0 font-normal tracking-[0.08em] uppercase">
                  {STATUS_LABEL[status]}
                </h2>
                <span
                ...
                />
                <span
                  className="text-mono-sm inline-flex h-5 min-w-5 items-center justify-center rounded-sm px-1.5"
                  style={{ background: "var(--bg-hover-soft)", color: "var(--fg-muted)" }}
                >
                  {list.length}
                </span>
              </div>
              ...
              {list.length === 0 && (
                <p
                  className="text-mono-sm m-0 rounded-md border border-dashed px-4 py-8 text-center font-mono"
