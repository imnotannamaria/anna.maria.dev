...
description: "Starter kit of e-commerce transactional email templates built with Resend + React Email."
date: "2026-04-04"
tags:
  [
    "react",
...
cover: "/projects/resend-ecommerce.png"
featured: false
published: true
---
...
![resend-ecomemerce](/blog/resend-ecomemerce.webp)
...
**April 2026 — Migrated to React Email 6**

React Email 6 was released with a unified package structure. All components previously imported from `@react-email/components` are now available directly from `react-email`. This project has been updated to reflect that change.
...
![resend-ecomemerce-draw](/blog/resend-ecomemerce-draw.webp)
