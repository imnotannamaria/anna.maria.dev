...
Postgres — so there is a real moment where the card is a four-row skeleton, and that skeleton
has been on the site since the day the home page was split into slots.
