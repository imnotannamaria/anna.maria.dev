...
leans on (`Card`, `CardHeader`, `CardFooter`, `useReveal`, `useSpotlight`) come from
[entrepta](https://entrepta.vercel.app), copied into this repo, and the card degrades to a plain
div if you drop them.
