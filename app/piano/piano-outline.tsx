...
/**
 * Markdown-style outline for /piano — mirrors the editor "outline" panel.
 * Sticky on ≥1100px, hidden below. IntersectionObserver drives the scrollspy;
 * clicking scrolls the <main> container with a small top offset.
 */
export function PianoOutline({ items }: { items: OutlineItem[] }) {
