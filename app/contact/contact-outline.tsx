...
/**
 * Markdown-style outline for /contact — mirrors the editor "outline" panel.
 * Sticky on ≥1100px, hidden below. Uses IntersectionObserver to highlight the
 * section currently in view (scrollspy) and scrolls the <main> container on
 * click with a small top offset so headings don't sit flush under the chrome.
 */
export function ContactOutline({ items }: { items: OutlineItem[] }) {
